...
class SendOrPay(db.Model):
    ...
    def __init__(self, service=None, direction=None, commitment=None, commitmentService=None, agreement_fk=None):
    ...
    def __repr__(self):
        return "<SendOrPay(service='%s', direction='%s', commitment='%s', commitmentService='%s', agreement_fk='%s')>" % (
                   self.service, self.direction, self.commitment, self.commitmentService, self.agreement_fk)