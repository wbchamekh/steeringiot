...
class BalancedUnbalanced(db.Model):
    ...
    def __init__(self, service=None, direction=None, balanced=None, unbalanced=None, agreement_fk=None):
    ...
    def __repr__(self):
        return "<BalancedUnbalanced(service='%s', direction='%s', balanced='%s', unbalanced='%s', agreement_fk='%s')>" % (
                   self.service, self.direction, self.balanced, self.unbalanced, self.agreement_fk)
